...
{
    public partial class client_vh_form : Form
    {
        public client_vh_form()
        {
            InitializeComponent();
        }

        private void client_vh_form_Load(object sender, EventArgs e)
        {
        ...
        private void bindingNavigatorAddNewItem_Click_1(object sender, EventArgs e)
        {
            ...
            iD_КлиентTextBox.Text = bindingNavigatorPositionItem.Text;
        }
    }
}